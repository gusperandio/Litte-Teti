...
export default function product() {
  ...
  useEffect(() => {
    url += `/${router.query.id}/${product.girl}`;
    if (router.query.id) {
  ...
  const BtnGirl = () => {
    return (
      <button className={style.btnGirl}>
        Comprar
    ...
    <>
      ...
      <div className={style.bread}>
        <Breadcrumb style={{ maxWidth: "300px" }}>
          ...
          {/* {product.girl ? (
          <Breadcrumb.Item href="/girls">Meninas</Breadcrumb.Item>
          ) : (
            <Breadcrumb.Item href="/boys">Meninos</Breadcrumb.Item>
          )} */}
      ...
      <div className="animate__animated animate__fadeIn">
            ...
            <div className={style.card}>
              {product.image.length === 1 ? (
                ...
                <div
                  ...
                  className={`carousel slide carousel-fade ${style.cardimg}`}
                  data-ride="carousel"
                >
                  <ol className="carousel-indicators">
                    {product.image.map((img: any, index) => {
                      return index === 0 ? (
                        <li
              ...
              <div className={style.boxText}>
                ...
                <p className={style.cardp}>
                  R${" "}
                  {product.price_fake.split(".")[1].length === 1
                    ? product.price_fake + "0"
                    : product.price_fake}
                </p>
                ...
                <h3 className={`${style.cardh3} ${style.colormoneyBoy}`}>
                  ...
                  <small>
                    {product.price.split(".")[1].length === 1
                ...
                <div>
                  <p style={{ marginBottom: "1rem" }}>Tamanhos:</p>
        ...
        <div
          className="middle animate__animated animate__fadeIn animate__delay-1s"
